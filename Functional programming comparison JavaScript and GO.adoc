image::images/logo-th-rosenheim-2019.png[TH Rosenheim, 200, 200]
...
== 3	Comparison Go and JavaScript
...
[10] ANTHONY HEDDINGS, What’s the Benefit of Statically Typed Programming Languages, https://www.cloudsavvyit.com/6626/whats-the-benefit-of-statically-typed-programming-languages/
